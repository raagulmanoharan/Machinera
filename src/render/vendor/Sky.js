// Vendored verbatim from three.js master:
//   examples/jsm/objects/Sky.js
// https://github.com/mrdoob/three.js — MIT License, © three.js authors
//
// The pinned three.js here is 0.170.0, whose Sky has no clouds; the version the
// ocean example runs does. Its imports are only BackSide, BoxGeometry, Mesh,
// ShaderMaterial, UniformsUtils and Vector3, all present in 0.170, so it drops
// in unmodified. Do not edit — replace wholesale when updating three.js.
import {
	BackSide,
	BoxGeometry,
	Mesh,
