...
export const MOODS = [
  {
    name: 'Winter Dusk',
    fog: [0x3d4855, 0.022], exposure: 0.66, env: 0.34,
  ...
  {
    name: 'Deep Night',
    fog: [0x28313f, 0.024], exposure: 0.6, env: 0.26,
  ...
  {
    name: 'Blue Dusk',
    fog: [0x354259, 0.023], exposure: 0.65, env: 0.32,
  ...
  {
    name: 'Ashen Overcast',
    fog: [0x4a4f56, 0.023], exposure: 0.68, env: 0.36,
  ...
  {
    name: 'Dead Fields',
    fog: [0x3d402e, 0.023], exposure: 0.65, env: 0.32,
  ...
  {
    name: 'Barren Dust',
    fog: [0x463c2c, 0.023], exposure: 0.65, env: 0.32,
