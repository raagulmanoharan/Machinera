...
export const MOODS = [
  {
    name: 'Winter Dusk',
    fog: [0x0c1017, 0.010], exposure: 0.52, env: 0.3,
    skyElev: -5, skyTurb: 3, skyRayl: 1.6,
    sun: [0x5a6675, 0.32], hemi: [0x8f99a8, 2.8], moon: [0x93a9cc, 0.55],
    grade: [0.93, 0.96, 1.03], night: 0.5, lamps: 0.0, headlights: 0.6,
  },
  {
    name: 'Deep Night',
    fog: [0x05080e, 0.014], exposure: 0.5, env: 0.2,
    skyElev: -11, skyTurb: 2, skyRayl: 0.7,
    sun: [0x28374d, 0.16], hemi: [0x5c6678, 2.5], moon: [0x8ea6cf, 0.95],
    grade: [0.9, 0.96, 1.12], night: 0.97, lamps: 0.0, headlights: 1.0,
  },
  {
    name: 'Blue Dusk',
    fog: [0x0a0f1a, 0.011], exposure: 0.5, env: 0.26,
    skyElev: -7, skyTurb: 3, skyRayl: 2.0,
    sun: [0x3a4d6c, 0.3], hemi: [0x7a8aa0, 2.7], moon: [0x8aa2c8, 0.62],
    grade: [0.85, 0.94, 1.13], night: 0.75, lamps: 0.0, headlights: 0.9,
  },
  {
    name: 'Ashen Overcast',
    fog: [0x181b1e, 0.011], exposure: 0.52, env: 0.3,
    skyElev: -3, skyTurb: 7, skyRayl: 1.3,
    sun: [0x777b7f, 0.44], hemi: [0x969ca6, 2.9], moon: [0xa9b0bc, 0.3],
    grade: [0.96, 0.97, 0.98], night: 0.35, lamps: 0.0, headlights: 0.6,
  },
  {
    name: 'Dead Fields',
    fog: [0x111309, 0.011], exposure: 0.5, env: 0.26,
    skyElev: -4, skyTurb: 5, skyRayl: 1.5,
    sun: [0x5f6252, 0.44], hemi: [0x8b917a, 2.6], moon: [0x9aa6ad, 0.42],
    grade: [0.97, 1.0, 0.9], night: 0.5, lamps: 0.0, headlights: 0.7,
  },
  {
    name: 'Barren Dust',
    fog: [0x14100a, 0.011], exposure: 0.5, env: 0.26,
    skyElev: -4, skyTurb: 9, skyRayl: 1.3,
    sun: [0x7a6a44, 0.44], hemi: [0x9a8f78, 2.6], moon: [0xb2ad9e, 0.46],
